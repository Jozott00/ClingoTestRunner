...
def main():
    ...
    parser.add_argument(
        ...
        type=int,
        nargs=1,
        help="Number of test files. Must be of format <file_to_test>_<x>.dl, must be in same folder as the file to test and <x> must begin with 0",
    )
    ...
    for i in range(test_file_count):
        test_for_file(f"{test_prefix}_{i}.dl")
